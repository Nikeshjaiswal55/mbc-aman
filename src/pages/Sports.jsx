...
function SportsSeries() {
  ...
  console.log("sportData", sportData?.data);

  useEffect(() => {
    sportDataCall("/api/search?category_id=3");
  }, []);
  ...
  return (
    <div className="container">
      ...
      <div className="row network-container" style={{ color: "black" }}>
        ...
        ) : sportData?.data?.items.data.length > 0 ? (
          sportData?.data?.items.data?.map((item) => (
